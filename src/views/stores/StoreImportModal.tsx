...
import { productSample, storeSample } from '../../utility/apis/ExportLanguage'
import httpConfig from '../../utility/http/httpConfig'
import CenteredModal from '../components/modal/CenteredModal'
import { useImportStoreMutation } from '../../redux/RTKQuery/StoreRTK'
...
export default function StoreImportModal<T>(props: T & dataType) {
  const {
    edit = null,
    noView = false,
    active = false,
  ...
  ///IMPORT Product
  const [importStore, resultData] = useImportStoreMutation()

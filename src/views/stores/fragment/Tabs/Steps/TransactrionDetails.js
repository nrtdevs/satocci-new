...
import { ChevronDown, Edit, Eye, MoreVertical, RefreshCcw, Trash } from 'react-feather'
import {
  Badge,
  Button,
  ButtonGroup,
...
function Stores({ details = null }) {
  ...
  const storesData = useSelector((s) => s?.stores?.stores?.data)
  ...
  const CustomPagination = () => (
    <div className='d-flex p-1 align-items-center border-top'>
      <div className='flex-1 d-flex align-items-center'>
        ...
        />
        <div className='ms-2'> Showing 4 of 400 Records </div>
      </div>
      <ReactPaginate
        previousLabel=''
        nextLabel=''

...
import { SubscriptionParamsType } from '.'
import { useLoadCouponDetailsByIdMutation } from '../../../redux/RTKQuery/CouponRTK'
import { useExportSubscriptionLogMutation } from '../../../redux/RTKQuery/SubscriptionRTK'
...
export default function Export<T>(props: T & dataType) {
    const {
        edit = null,
        noView = false,
        showModal = false,
    ...
    const {
        ...
        watch,
        reset
    } = useForm<SubscriptionParamsType>()
    ...
    const user = useUser()
    const [exports, result] = useExportSubscriptionLogMutation()
    ...
    const handleSave = (d: ExportParams) => {
        exports({
            ...
            to_date: d?.to_date,
            subscription_type: watch('store_id')?.extra?.store_subscription?.subscription_type
        })
    }

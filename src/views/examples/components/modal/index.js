...
const Modals = () => {
  ...
  return (
    <Fragment>
      <BreadCrumbs title='Modal' data={[{ title: 'Components' }, { title: 'Modal' }]} />
      <Row>
        <Col sm='12'>
          <Card title='Modal Basic' code={modalBasic}>
            <CardText className='mb-0'>
              Use <code>Modal</code>, <code>ModalBody</code> and <code>ModalFooter</code> tags to
              create a Modal with reactstrap.
            </CardText>
            <ModalBasic />
          </Card>
        </Col>
      ...
      <Row>
        <Col sm='12'>
          <Card title='Modal Themes' code={modalTheme}>
            <CardText className='mb-0'>
              Use class <code>.modal-[color]</code> with your <code>.modal</code> to change theme of
              modal
            </CardText>
            <ModalThemes />
          </Card>
        ...
        <Col sm='12'>
          <Card title='Modal Sizes' code={modalSizes}>
            <CardText className='mb-0'>
              Use class <code>.modal-[xs/sm/lg/xl]</code> with <code>ModalHeader</code> to change
              modal Size.
            </CardText>
            <ModalSizes />
          </Card>
      ...
      <Row>
        ...
        <Col sm='12'>
          <Card title='Unmount On Close' code={modalUnmount}>
            <CardText>
              Write something (data should remain in modal if unmountOnClose is set to false).
            </CardText>
            <ModalUnmount />
          </Card>
        </Col>

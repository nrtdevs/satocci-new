      ...
      <Row>
        <Col md='6' sm='12'>
          <Card title='Controlled Popover' code={popoverControlled}>
            <CardText>
              For controlled Popover you'll have to manage state of component. Controlled Popover
              require <code>isOpen</code> and <code>toggle</code> props to work.
            </CardText>
            <PopoverControlled />
          </Card>
        </Col>
        <Col md='6' sm='12'>
          <Card title='Uncontrolled Popover' code={popoverUncontrolled}>
            <CardText>
              You can create an uncontrolled popover without having to manage state. All you have to
              do is wrap your content inside UncontrolledPopover tag.
            </CardText>
            <PopoverUncontrolled />
          </Card>
        </Col>
      ...
      <Row>
        ...
        <Col sm='12'>
          <Card title='Popover Triggers' code={popoverTriggers}>
            <CardText className='mb-0'>
              Use prop <code>trigger</code> for various trigger options. Trigger each popover to see

      ...
      <Row>
        <Col sm='12'>
          <Card title='Filled' code={filledButtons}>
            <CardText className='mb-0'>
              Reactstrap includes six predefined button styles, each serving its own semantic
              purpose.
            </CardText>
            <FilledButtons />
          </Card>
        ...
        <Col sm='12'>
          <Card title='Icon Only' code={iconOnlyButtons}>
            <CardText className='mb-0'>
              ...
              <code>.rounded-circle</code> with <code>.btn-icon</code>. You can only use{' '}
              <code>.btn-icon</code> when you only want icon in your button
            </CardText>
            <IconOnlyButtons />
          </Card>
        </Col>
        ...
        <Col sm='12'>
          <Card title='Block Level Buttons' code={buttonBlock}>
            <CardText>
              Create block level buttons with a mix of our display and gap utilities or by using

      ...
      <Row className='match-height'>
        ...
        <Col md='6' sm='12'>
          <Card title='Colored Growing Spinners' code={spinnerGrowColors}>
            <CardText className='mb-0'>
              Use <code>color</code> and <code>type</code> attribute to create a colored growing
              spinner.
            </CardText>
            <SpinnerGrowColors />
          </Card>
        ...
        <Col md='6' sm='12'>
          <Card title='Flex' code={spinnerFlex}>
            <CardText>
              Use Flexbox utilities to place spinners.Use <code>.d-flex</code> and{' '}
              <code>.justify-content-[side]</code>.
            </CardText>
            <SpinnerFlex />
          </Card>
        </Col>
        ...
        <Col md='6' sm='12'>
          <Card title='Text Alignment' code={spinnerTextAlignment}>
            <CardText>
              You can also use <code>.text-[side]</code> as a wrapper to spinner tag to change
              spinner's position.
            </CardText>
            <SpinnerTextAlignment />
          </Card>
        ...
        <Col md='6' sm='12'>
          <Card title='Sizes' code={spinnerSizes}>
            <CardText className='mb-0'>
              Use prop <code>size="sm"</code> for Small spinner or use <code>style</code> prop for
              custom size.
            </CardText>
            <SpinnerSizes />
          </Card>

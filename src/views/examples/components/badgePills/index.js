      ...
      <Row>
        ...
        <Col sm='12'>
          <Card title='Glow' code={badgePillGlow}>
            <CardText className='mb-0'>
              Use class <code>.badge-glow</code> with <code>Badge</code> tag to add glow effect to
              your badge.
            </CardText>
            <BadgeGlow />
          </Card>
        ...
        <Col sm='12'>
          <Card title='Light' code={badgePillLight}>
            <CardText className='mb-0'>
              Use prop <code>pill</code> and <code>color="light-COLOR_NAME"</code> with{' '}
              <code>Badge</code> tag to create a light badge pill.
            </CardText>
            <BadgePillLight />
          </Card>
        </Col>
        <Col sm='12'>
          <Card title='Notifications' code={badgePillNotification}>
            <CardText className='mb-0'>
              Use <code>.badge-up</code> to set pill badge to higher than other text. So that it can
              work with notifications also.
            </CardText>
            <BadgeNotification />
          </Card>
        </Col>

      ...
      <Row className='match-height'>
        <Col md='6' sm='12'>
          <Card title='Base Nav' code={navBasic}>
            <CardText>
              The base nav component provides a strong foundation for building all types of
        ...
        <Col md='6' sm='12'>
          <Card title='With Border' code={navBorder}>
            <CardText>
              Use Class <code>.wrap-border</code> with your <code>nav</code> tag to wrap your nav
              with a border
            </CardText>
            <NavBorder />
          </Card>
        ...
        <Col md='6' sm='12'>
          <Card title='Center Alignment' code={navCenter}>
            <CardText>
              Use Class <code>.justify-content-center</code> with your <code>nav</code> tag to align
              your nav to center.
            </CardText>
            <NavCenter />
          </Card>
        ...
        <Col md='6' sm='12'>
          <Card title='End Alignment' code={navEnd}>
            <CardText>
              Use Class <code>.justify-content-end</code> with your <code>nav</code> tag to align
              your nav to End.
            </CardText>
            <NavEnd />
          </Card>
        ...
        <Col md='6' sm='12'>
          <Card title='Nav With square Border' code={navSquareBorder}>
            <CardText>
              To wrap with square border, use <code>.square-border</code> class with{' '}
              <code>.wrap-border</code> class.
            </CardText>
            <NavSquareBorder />
          </Card>
        </Col>

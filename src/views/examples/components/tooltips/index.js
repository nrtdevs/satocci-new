      ...
      <Row>
        <Col xl='6' lg='12'>
          <Card title='Controlled Tooltip' code={tooltipControlled}>
            <CardText>
              For controlled tooltips you'll have to manage state of component.controlled tooltips
        ...
        <Col xl='6' lg='12'>
          <Card title='Uncontrolled Tooltip' code={tooltipUncontrolled}>
            <CardText>
              UncontrolledTooltip does not require <code>isOpen</code> nor <code>toggle</code> props
              to work.All you have to do is provide a valid target to tooltip.
            </CardText>
            <TooltipUncontrolled />
          </Card>
        </Col>

      ...
      <Row>
        <Col md='6' sm='12'>
          <Card title='Controlled Dropdown' code={dropdownControlled}>
            <CardText>
              If you want to use controlled dropdown you'll have to manage state for it.
            </CardText>
            <DropdownControlled />
          </Card>
        </Col>
        ...
        <Col sm='12'>
          <Card title='Split' code={dropdownSplit}>
            <CardText className='mb-0'>
              Use class <code>.dropdown-toggle-split</code> and add a split button within your
              dropdown to create a dropdownSplit
            </CardText>
            <DropdownSplit />
          </Card>
        </Col>
        ...
        <Col sm='12'>
          <Card title='Directions' code={dropdownDirections}>
            <CardText className='mb-0'>
              You can use drop from different direction to use drop from <code>bottom right</code>{' '}
              use right prop with your dropdown-menu. for drop directions use{' '}
              <code>direction=[up/start/end]</code>
            </CardText>
            <DropdownDirections />
          </Card>
        </Col>
        <Col sm='12'>
          <Card title='Variations' code={dropdownVariations}>
            <CardText>
              To create a dropdown with groups you can use prop <code>header</code> for the header
              of groups and for separation of group you can use prop <code>divider</code>.
            </CardText>
            <CardText className='mb-0'>

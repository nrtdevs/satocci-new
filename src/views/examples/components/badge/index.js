      ...
      <Row>
        <Col sm='12'>
          <Card title='Contextual Badges' code={badgeContextual}>
            <CardText className='mb-0'>
              Use prop <code>color</code> with <code>Badge</code> tag to create badge with different
              colors.
            </CardText>
            <BadgeContextual />
          </Card>
        ...
        <Col sm='12'>
          <Card title='Light Badges' code={badgeLight}>
            <CardText className='mb-0'>
              Use prop <code>color="light-COLOR_NAME"</code> with <code>Badge</code> tag to create

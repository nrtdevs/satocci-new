...
export const getProducts: any = createAsyncThunk('appEcommerce/getProducts', async (params) => {
...
export const getWishlistItems: any = createAsyncThunk('appEcommerce/getWishlistItems', async () => {
  const response = await axios.get('/apps/ecommerce/wishlist')
  return response.data
})

export const deleteWishlistItem: any = createAsyncThunk(
...
export const getCartItems: any = createAsyncThunk('appEcommerce/getCartItems', async () => {
  const response = await axios.get('/apps/ecommerce/cart')
  return response.data
})

export const getProduct: any = createAsyncThunk('appEcommerce/getProduct', async (slug) => {
  const response = await axios.get(`/apps/ecommerce/products/${slug}`)
  return response.data
})

export const addToWishlist: any = createAsyncThunk('appEcommerce/addToWishlist', async (id) => {

      ...
      <Row>
        <Col md='6' sm='12'>
          <CardAction title='Collapse' actions='collapse'>
            <CardBody className='pt-0'>
              <CardText>
                You can create a collapsible content by using our <code>CardAction</code> component
                and by passing prop <code>actions='collapse'</code>.
              </CardText>
        ...
        <Col md='6' sm='12'>
          <CardAction title='Remove' actions='remove'>
            <CardBody className='pt-0'>
              <CardText>
                You can add refresh content action to card by adding class <code>.card-reload</code>{' '}
                with your card tag, and add conditional spinner into card body to show when card is
                refreshing.
              </CardText>
              <CardText className='mb-0'>
                Click on <RotateCw size={15} /> to see card refresh in action

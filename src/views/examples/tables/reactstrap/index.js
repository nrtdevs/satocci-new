  ...
  return (
    <Fragment>
      <Breadcrumbs
        ...
        data={[{ title: 'Forms & Tables' }, { title: 'Tables' }]}
      />
      <Row>
        <Col sm='12'>
        ...
        <Col sm='12'>
          <Card title='Table head Options' code={tableTheadOptions} noBody>
            <CardBody>
              <CardText>
                Similar to tables and dark tables, use the modifier classes <code>.table-dark</code>{' '}
            ...
            <CardBody className='mt-2'>
              <p className='m-0'>
                Use the modifier class <code>.table-light</code> to make <code>&lt;thead&gt;</code>{' '}
                appear light.
              </p>
            </CardBody>
            <TableTheadLight />
        ...
        <Col sm='12'>
          <Card title='Contextual classes' code={tableContextual} noBody>
            <CardBody>
              <CardText>
                Use class <code>table-[colorName]</code> with <code>&lt;tr&gt;</code> for contextual
                rows.
              </CardText>
            </CardBody>
            <TableContextual />
